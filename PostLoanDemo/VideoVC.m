...
@interface VideoVC ()<UICollectionViewDelegate,UICollectionViewDataSource,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,TakePictureCellDelegate>
{
...
- (void)photoMethod
{
    ...
    UIActionSheet * myActionSheet = [[UIActionSheet alloc] initWithTitle:nil delegate:self cancelButtonTitle:@"取消" destructiveButtonTitle:nil otherButtonTitles:@"从相册选择",@"拍摄", nil];
...
{
    //选择视频
    LLImagePickerController *imagePickerVC = [[LLImagePickerController alloc] initWithType:2];
    ...
    [imagePickerVC getSelectedPHAssetsMovieWithBlock:^(NSMutableArray<PHImageModel *> *videoArray, NSArray<PHAsset *> *assetsArray) {
        NSMutableArray *array = [[NSMutableArray alloc] initWithArray:videoArray];
...
- (void)takePhotosMothod
{
    ...
    if ([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypeCamera]) {
        ...
        cameraVC.cameraType = CameraTypeMovie;
        [cameraVC getResultFromCameraMovieWithBlock:^(PHImageModel *videoModel, PHAsset *phAsset) {
